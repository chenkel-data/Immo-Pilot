...
export default function App() {
  ...
  const [scrapeConfig, setScrapeConfig] = useState({ blacklistKeywords: [] });
  const loadScrapeConfig = useCallback(async () => {
    try {
                  ...
                  <div className="active-agent-details">
                    ...
                    {activeAgent.scrape_url && (
                      <span className="active-agent-url-wrap">
                        <span className="active-agent-url-label">Such-URL:</span>
                        <input
