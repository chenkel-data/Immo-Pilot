  ...
  return (
    <div className="filter-bar">
      ...
      <div className="filter-controls">
        ...
        <label className="filter-label filter-label--date">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="filter-date-icon"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
          <span className="filter-date-label" title="Einzug bis: Zeigt nur Inserate an, bei denen der frühestmögliche Einzugstermin vor oder an diesem Datum liegt. Inserate ohne ein Bezugsdatum oder mit 'sofort' werden immer angezeigt.">Einzug bis ⓘ</span>
          <input type="date" className="input-date" value={maxAvailableFrom} onChange={(e) => onMaxAvailableFrom(e.target.value)} />
        </label>
