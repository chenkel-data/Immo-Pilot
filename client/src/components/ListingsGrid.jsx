      ...
      <div className="grid-state">
        <div className="empty-illustration">
          <svg viewBox="0 0 120 120" fill="none" className="empty-svg">
            ...
            <path
              d="M40 65 L60 45 L80 65 L80 85 L40 85 Z"
              fill="var(--surface)"
    ...
    <div className="grid-section">
      <div className="grid-info-bar">
        <p className="grid-info">
          <strong>{allCount}</strong> Ergebnis{allCount !== 1 ? 'se' : ''}{' '}
          <span className="grid-info-sep">·</span> Seite {page}/{pages}
        </p>
      ...
      <div className="listings-grid listings-grid--compact">
        {listings.map((l) => (
          <ListingCard
            ...
            onDetails={onDetails}
            prefetchedImages={imageCache[l.id] || null}
            isBlacklistView={isBlacklistView}
          />
        ))}
      </div>
      {pages > 1 && (
