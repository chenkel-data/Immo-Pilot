 ...
 *   message    – body text (can also be JSX)
 *   confirm    – label for the confirm button (default: "Bestätigen")
 *   danger     – bool; renders the confirm button in red
 *   onConfirm  – callback when confirmed
 *   onCancel   – callback when cancelled / backdrop clicked
 */
